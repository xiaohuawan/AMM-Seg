...
#         results = model.predict(picpath)  # 使用predict方法进行预测
...
#         labeled_array_dir = os.path.join(os.path.dirname(output_path), 'labeled_array')
#         os.makedirs(labeled_array_dir, exist_ok=True)
        
#         with open(output_path, 'w') as f:
#             label_array_path = os.path.join(labeled_array_dir, "label_array.npy")
...
# def run_classification(image_paths, model_path):
#     results = []
...
#         results_path = os.path.join(os.path.dirname(image_path), 'results.txt')
#         mito_cls.save_results(results_path)
#         result = mito_cls.get_results(results_path)
#         results.append({
#             'image': image_path,
#             'result': result
#         })
...
#             # img_filename = f"{base_filename}_predict_{idx}.png"
...
#     def move_images_and_save_paths(source_dir, target_dir, json_filename):
#         # Ensure the target directory exists
#         if os.path.exists(target_dir):
#             shutil.rmtree(target_dir)
#         os.makedirs(target_dir, exist_ok=True)
        
#         # List to store image paths in the new directory
#         image_paths = []
        
#         # Iterate over all files in the source directory
#         for filename in os.listdir(source_dir):
#             if filename.endswith(('.png', '.jpg', '.jpeg', 'tif')):  # Add any other image extensions if needed
...
#                 # Append the new relative path to the list
#                 relative_path = f"../../free/class_source/{filename}"
...
#         print(f"Moved {len(image_paths)} images to {target_dir} and saved paths in {json_path}")

#     # Define source, target directories and json filename
...
#     move_images_and_save_paths(source_directory, target_directory, json_filename)
...
#     update_image_paths(os.path.join(os.path.abspath('../../vite/public/class_predict'), 'image_paths.json'), os.path.abspath('../../vite/public/class_predict'))
